...
function App() {
  const [state, handleSubmit] = useForm("xbjnwzjg");
  if (state.succeeded) {
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} style={{ maxWidth: '400px', margin: 'auto', marginBottom: '50px', padding: '20px', border: '1px solid #ccc', borderRadius: '5px' }}>
          ...
          />
          <button
          className='py-2 px-4 bg-orange-400 text-white rounded-lg shadow-md hover:bg-orange-300 focus:outline-none m-3 my-1'
            type="submit"
